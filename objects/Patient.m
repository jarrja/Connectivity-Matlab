classdef Patient < handle
    ...
    methods
        ...
        function obj = Patient(numPat,fileName,locationName,Fs,rangeSeg)
        ...
        function eegDataFreqBand(obj) %DataFreqBand = get.dataFreqBand(obj) Edit 9/21/15
        ...
        function eegAverageMontage(obj)
            meanData = mean(mean(obj.data));
            obj.data = obj.data - meanData;
        end
        function eegConnectivity(obj)
            for i=1:1:obj.numberOfSegment
               obj.dataFreqBandConnectivity{i}(:,:,1) = eeg_connectivity( obj.dataFreqBandSegment{i}(:,:,1));
                obj.dataFreqBandConnectivity{i}(:,:,2) = eeg_connectivity( obj.dataFreqBandSegment{i}(:,:,2));
                obj.dataFreqBandConnectivity{i}(:,:,3) = eeg_connectivity( obj.dataFreqBandSegment{i}(:,:,3));
                obj.dataFreqBandConnectivity{i}(:,:,4) = eeg_connectivity( obj.dataFreqBandSegment{i}(:,:,4)); 
            end            
        end
